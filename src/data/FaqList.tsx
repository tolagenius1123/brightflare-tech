...
const faqList: FAQProps[] = [
    {
        ...
        answer: (
            <>
                <p>
                    It’s a free 4-week program offering foundational tech training with 1-hour weekly sessions led by industry experts.
                </p>
            </>
        ),
    },
    ...
    },
    {
        ...
        answer: (
            <>
                Yes, you can request a personal tutor to guide you. Details are available on our registration page.{" "}
    ...
    },
    {
        ...
        answer: (
            <>
                The 3-month program offers hands-on projects, mentorship, certifications, and in-depth learning.
            </>
    ...
    },
    {
        ...
        answer: (
            <>
                Fill out the form, follow us on Instagram, subscribe to our YouTube channel, and use the secret code from our videos.
            </>
